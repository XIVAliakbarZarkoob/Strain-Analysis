...
figure("Name", "D parameter", "NumberTitle", "off")
worldmap([24,43],[40,64])
...
title("D parameter used for weighting by distance", "FontSize", FONTSIZE*1.2)

figure("Name", "Grid", "NumberTitle", "off")
worldmap([24,43]+2*[-1,1],[40,64]+2*[-1,1])
geoshow(countries, 'FaceColor', 0.8*ones(3,1), 'EdgeColor', 'k', 'LineWidth', 2);
plotm(result.Latitude, result.Longitude, "b.")
title("Grid used for computation", "FontSize", FONTSIZE*1.2)